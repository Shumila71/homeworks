...
import org.task18.service.TeamService;
...
public class TeamController
{
    ...
    @PostMapping()
    public ResponseEntity AddTeam(@RequestBody org.task18.entity.Team team) throws SQLException
    {
    ...
    @GetMapping()
    public List<org.task18.entity.Team> GetAllTeam() throws SQLException
    {
        return teamService.GetTeams();
    }

    @GetMapping("/{id}")
    public org.task18.entity.Team GetTeamById(@PathVariable Long id) throws SQLException
    {
