...
import org.task22.service.TeamService;
...
public class TeamController
{
    ...
    @PostMapping()
    public ResponseEntity AddTeam(@RequestBody org.task22.entity.Team team) throws SQLException
    {
    ...
    @GetMapping()
    public List<org.task22.entity.Team> GetAllTeam() throws SQLException
    {
        return teamService.GetTeams();
    }

    @GetMapping("/{id}")
    public org.task22.entity.Team GetTeamById(@PathVariable Long id) throws SQLException
    {
