...
import ru.mirea.trppsecond15.Receipt;
...
public class ReceiptController {
    ...
    public ReceiptController() {
        receiptList = new CsvToBeanBuilder<Receipt>(new InputStreamReader(this.getClass().getResourceAsStream(
                "/MOCK_DATA.csv"))).withType(Receipt.class).build().parse();
    }
